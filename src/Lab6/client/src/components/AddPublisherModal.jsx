...
export default function AddPublisherModal({ isShowing, setIsShowing, setSubmissionStatus }) {
    const handleClose = () => {
        setIsShowing(false);
    };

    const [addPublisher, { loadingMut, errorMut, dataMut }] = useMutation(ADD_PUBLISHER, {
                ...
                <div>
                    <Form onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="establishedYear" type="number" required></Form.Control>
                        </Form.Group>

                        <Form.Group>
                            <Form.Label htmlFor="location">Location</Form.Label>
                            <Form.Control id="location" type="text" required></Form.Control>
                        </Form.Group>
