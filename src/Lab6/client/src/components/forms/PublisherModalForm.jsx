...
export default function PublisherModalForm({
    publisherId,
    handleClose,
    setSubmissionStatus
}) {
    ...
    const [editPublisher, { loadingMut, errorMut, dataMut }] = useMutation(
        EDIT_PUBLISHER,
        {
            onCompleted: () =>
                setSubmissionStatus({
    ...
    const handleSubmit = (e) => {
        ...
        editPublisher({
            variables: { id: publisherId, name, establishedYear, location }
                ...
                <Form onSubmit={(e) => handleSubmit(e)}>
                    <Form.Group>
                        ...
                        <Form.Control
                            ...
                            type="text"
                            required
                            defaultValue={data.getPublisherById.name}
                        ></Form.Control>
                    </Form.Group>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control
                            ...
                            type="number"
                            required
                            defaultValue={data.getPublisherById.establishedYear}
                        ></Form.Control>
                    </Form.Group>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control
                            ...
                            type="text"
                            required
                            defaultValue={data.getPublisherById.location}
                        ></Form.Control>
                    </Form.Group>
